<?php
namespace Tx\BeAcl\Tests\Unit\Cache;
...
class PermissionCacheTest extends UnitTestCase {
	...
	/**
	 * @var \Tx\BeAcl\Cache\PermissionCache|\PHPUnit_Framework_MockObject_MockObject
	 */
	...
	public function flushingCacheInvalidatesPreviouslySetFirstLevelCache() {
		...
		/** @var \Tx\BeAcl\Cache\TimestampUtility|\PHPUnit_Framework_MockObject_MockObject $timestampUtility */
		$timestampUtility = $this->getMock('Tx\\BeAcl\\Cache\\TimestampUtility', array('updateTimestamp', 'permissionTimestampIsValid'));
	...
	public function previouslySetCacheValueIsReturnedBySecondLevelCache() {
		...
		/** @var \Tx\BeAcl\Cache\TimestampUtility|\PHPUnit_Framework_MockObject_MockObject $timestampUtility */
		$timestampUtility = $this->getMock('Tx\\BeAcl\\Cache\\TimestampUtility', array('permissionTimestampIsValid'));
	...
	protected function initializePermissionCacheMock($mockedMethods) {
		...
		$permissionCache = $this->getMock('Tx\\BeAcl\\Cache\\PermissionCache', $mockedMethods);
